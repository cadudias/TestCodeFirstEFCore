...
namespace TestCodeFirstEFCore.Migrations
{
    ...
    [Migration("20180924002559_SeedMoreComputers")]
    partial class SeedMoreComputers
    {
            ...
            modelBuilder.Entity("TestCodeFirstEFCore.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, ClientId = 1, Name = "MackBook pro 128 gb" },
                        new { Id = 2, ClientId = 1, Name = "MackBook pro 256 gb" },
                        new { Id = 3, ClientId = 1, Name = "MackBook Air" },
                        new { Id = 4, ClientId = 1, Name = "PlayStation 100" }
                    );
                });
