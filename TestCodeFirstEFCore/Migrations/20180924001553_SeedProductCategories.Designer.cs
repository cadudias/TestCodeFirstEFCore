...
namespace TestCodeFirstEFCore.Migrations
{
    ...
    [Migration("20180924001553_SeedProductCategories")]
            ...
            modelBuilder.Entity("TestCodeFirstEFCore.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, ClientId = 1, Name = "MackBook pro" },
                        new { Id = 2, ClientId = 1, Name = "MackBook Air" },
                        new { Id = 3, ClientId = 1, Name = "PlayStation 100" }
                    );
                });
